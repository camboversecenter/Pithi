...
interface OwnerCeremonyFormProps {
...
const OwnerCeremonyForm: React.FC<OwnerCeremonyFormProps> = ({ initialData, onSave, onCancel, isSaving, currentUser }) => {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 animate-fade-in pb-20">
            <div className="flex items-center gap-4">
                <Button variant="ghost" onClick={onCancel} className="pl-0 text-slate-500 hover:bg-transparent hover:text-rose-600">
            ...
            <div className="border-b border-slate-200 pb-6">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">បំពេញព័ត៌មានលម្អិតដើម្បីបង្កើតកម្មវិធីដ៏អស្ចារ្យរបស់អ្នក។</p>
                </div>
            </div>
                    ...
                    <Card title="រូបភាព & សារ">
                            ...
                            <div className="flex justify-between items-center mb-3">
                                ...
                                <button 
                                    ...
                                    className="text-xs text-rose-600 font-bold flex items-center hover:bg-rose-50 px-3 py-1.5 rounded-lg transition-colors disabled:opacity-50 border border-rose-100"
                                >
                            ...
                            <div className="relative border-2 border-dashed border-slate-200 rounded-2xl p-6 bg-slate-50 flex flex-col items-center justify-center text-center transition-all hover:border-rose-300 hover:bg-rose-50/30">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="relative w-40 h-40 mx-auto border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50 flex flex-col items-center justify-center text-center transition-all hover:border-rose-300 hover:bg-rose-50/30">
                            ...
                            <textarea 
                                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-4 focus:ring-rose-50 focus:border-rose-300 outline-none transition-all placeholder:text-slate-400 text-slate-700 font-medium"
                                rows={4}
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 sticky top-6">
                        <div className="flex flex-col gap-4">
                            <Button className="w-full py-4 text-base shadow-xl shadow-rose-200" onClick={handleSave} isLoading={isSaving}>
...
export default OwnerCeremonyForm;
