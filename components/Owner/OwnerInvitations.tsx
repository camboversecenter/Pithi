...
interface OwnerInvitationsProps {
    ceremony: Ceremony;
    ...
    return (
        <div className="space-y-6 animate-fade-in-up">
            <div className="flex justify-between items-center">
                ...
                <Button onClick={() => setIsTemplateModalOpen(true)}><Plus size={18} className="mr-2"/> បង្កើតគំរូថ្មី</Button>
            </div>
                    ...
                    <div key={t.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-all group">
                        ...
                        <div className="p-4">
                            <div className="flex justify-between items-center mb-2">
                                <span className="bg-slate-100 text-slate-600 px-2 py-0.5 rounded text-xs font-bold uppercase">{t.type}</span>
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-3 border-t border-slate-50">
                                ...
                                <button 
                                    ...
                                    className="text-xs font-bold text-rose-600 flex items-center hover:underline"
                                >
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <button onClick={handleGenerateTemplateMessage} className="text-xs text-rose-600 font-bold flex items-center hover:underline" disabled={isGeneratingMessage}>
                        ...
                        <div className="flex justify-between items-center mb-1.5">
                            ...
                            <button onClick={handleGenerateTemplateBanner} className="text-xs text-rose-600 font-bold flex items-center hover:underline" disabled={isGeneratingBanner}>
