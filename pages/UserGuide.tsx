      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 p-8 bg-white rounded-[2.5rem] border border-slate-100 text-center shadow-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <a href="https://t.me/+DBOU-zZhP_lkNTg9" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-[#24A1DE] text-white rounded-full text-sm font-bold hover:bg-[#1f87ba] transition-all flex items-center gap-2 shadow-lg shadow-blue-100">
